...
public class EssenceEcommLocatorss extends  CommonFunctions {
	...
	public EssenceEcommLocatorss(WebDriver driver) {
	...
	public void cart() {
		...
		addtocart.click();
		 WebDriverWait wait = new WebDriverWait(DriverInit.driver, Duration.ofSeconds(5));
	...
	public void clickChekout() {
		...
		checkoutimage.click();
		 ...
		 WebDriverWait wait1 = new WebDriverWait(DriverInit.driver, Duration.ofSeconds(6));
		 wait1.until(ExpectedConditions.elementToBeClickable(checkout));
	
		 WebElement hoverOnCheckOut = checkout;
			action.moveToElement(hoverOnCheckOut).build().perform();
		checkout.click();
	}
	...
	public void selectPayments() {
		...
		cash_on_delivery.click();
		 WebDriverWait wait1 = new WebDriverWait(DriverInit.driver, Duration.ofSeconds(5));
		...
		direct_bank_transfer.click();
		 WebDriverWait wait2 = new WebDriverWait(DriverInit.driver, Duration.ofSeconds(5));
		...
		credit_card.click();
		 WebDriverWait wait3 = new WebDriverWait(DriverInit.driver, Duration.ofSeconds(5));
	...
	public void conditions()  {
		...
		check2.click();
		WebDriverWait wait1 = new WebDriverWait(DriverInit.driver,Duration.ofSeconds(5));
		wait1.until(ExpectedConditions.elementToBeClickable(check2));
		check2.isDisplayed();
		check2.isEnabled();
		check2.isSelected();
