...
public class EssenceEcommWebElements {
	...
	public void clickChekout() {
		...
		checkoutimage.click();
		 ...
		 WebDriverWait wait1 = new WebDriverWait(DriversInit.driver, Duration.ofSeconds(6));
	...
	public void conditions()  {
		...
		check1.click();
		WebDriverWait wait = new WebDriverWait(DriversInit.driver,Duration.ofSeconds(10));
		...
		check2.click();
		WebDriverWait wait1 = new WebDriverWait(DriversInit.driver,Duration.ofSeconds(10));
		...
		check3.click();
		WebDriverWait wait2 = new WebDriverWait(DriversInit.driver,Duration.ofSeconds(10));
